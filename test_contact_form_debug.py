...
try:
    ...
    print("[DEBUG] Name field found, filling with 'John Doe'...")
    ...
    print("[DEBUG] Email field found, filling with 'johndoe@example.com'...")
    ...
    print("[DEBUG] Phone field found, filling with '+46730123456'...")
